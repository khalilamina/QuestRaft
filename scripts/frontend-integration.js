 ...
 * This file demonstrates how to integrate Questraft with a web frontend
 */

// For React/Vue/Angular applications
export class QuestraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuestraftClient(provider, contractAddress);
